...
class Listarinventariobebidaxede
{
    public function AjaxListarinventariobebidaxsede()
    {
        $tabla = "inventario_bebidas";
        $sede = $_POST['name_sede'];
            $respuesta = inventariobebidascontroller::ctrListarInventarioBebidasxsede($tabla, $sede);   
...
$resp = new Listarinventariobebidaxede();
$resp->AjaxListarinventariobebidaxsede();